...
<table border="0" table align="center" cellpadding="0" cellspacing="0" class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background:url(https://raw.githubusercontent.com/rg9400/Cloud-Tautulli-Theme/master/Background/blur-noise.png) center center fixed,url(https://raw.githubusercontent.com/rg9400/Cloud-Tautulli-Theme/master/Background/blur-light.png) center center/cover no-repeat fixed!important;height:100%;width:25%; border-radius: 3px;" width="100%">
    <tr>
